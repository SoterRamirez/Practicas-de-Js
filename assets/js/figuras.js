...
const square_perimeter_result = document.querySelector(
  "#perimeter_square_result"
);
...
const triangle_perimeter_result = document.querySelector(
  "#perimeter_triangle_result"
);

const circle_input = document.querySelector("#circle_input");
const circle_area_result = document.querySelector("#area_circle_result");
const circle_perimeter_result = document.querySelector(
  "#perimeter_circle_result"
);
